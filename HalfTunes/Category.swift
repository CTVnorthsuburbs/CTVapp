...
var categories:
    [Category] = [Category(categoryFactory: CategoryFactory(factorySettings: home())),
                  Category(categoryFactory: CategoryFactory(factorySettings: baseball())),
                  Category(categoryFactory: CategoryFactory(factorySettings: basketball())),
                  Category(categoryFactory: CategoryFactory(factorySettings: concerts())),
                  Category(categoryFactory: CategoryFactory(factorySettings: football())),
                  Category(categoryFactory: CategoryFactory(factorySettings: graduations())),
                  Category(categoryFactory: CategoryFactory(factorySettings: gymnastics())),
                  Category(categoryFactory: CategoryFactory(factorySettings: hockey())),
                  Category(categoryFactory: CategoryFactory(factorySettings: lacrosse())),
                  Category(categoryFactory: CategoryFactory(factorySettings: meetings())),
                  Category(categoryFactory: CategoryFactory(factorySettings: news())),
                  Category(categoryFactory: CategoryFactory(factorySettings: parades())),
                  Category(categoryFactory: CategoryFactory(factorySettings: programs())),
                  Category(categoryFactory: CategoryFactory(factorySettings: soccer())),
                  Category(categoryFactory: CategoryFactory(factorySettings: softball())),
                  Category(categoryFactory: CategoryFactory(factorySettings: sports())),
                  Category(categoryFactory: CategoryFactory(factorySettings: swimming())),
                  Category(categoryFactory: CategoryFactory(factorySettings: teens())),
                  Category(categoryFactory: CategoryFactory(factorySettings: volleyball())),
                  Category(categoryFactory: CategoryFactory(factorySettings: ctvyoutube())) ]
...
class CategoryFactory
{
    ...
    init(factorySettings: CategoryFactorySettings) {self.settings = factorySettings}
    ...
    internal func addUpcomingSection() -> Section
    {
        ...
        return section
    }//internal func addUpcomingSection
    ...
    internal func addPopularSection() -> Section
    {
        ...
        let section = Section(sectionType: sectionType, sectionTitle: sectionTitle, searchID: searchID, videoList: videoList, buttons: buttons, displayCount: displayCount, images: images, sectionPlaylist: sectionPlaylist)
        return section
    }//internal function addPopularSection
    ...
    internal func addRecentGirlsSection() -> Section
    {
        ...
        let section = Section(sectionType: sectionType, sectionTitle: sectionTitle, searchID: searchID, videoList: videoList, buttons: buttons, displayCount: displayCount, images: images, sectionPlaylist: sectionPlaylist)
        return section
    }//internal function addRecentGirlsSection
    ...
    internal func addRecentBoysSection() -> Section
    {
        ...
        let section = Section(sectionType: sectionType, sectionTitle: sectionTitle, searchID: searchID, videoList: videoList, buttons: buttons, displayCount: displayCount, images: images, sectionPlaylist: sectionPlaylist)
        return section
    }//internal function addRecentBoysSection
    ...
    internal func addFeaturedSection() -> Section
    {
        ...
        let section = Section(sectionType: sectionType, sectionTitle: sectionTitle, searchID: searchID, videoList: videoList, buttons: buttons, displayCount: displayCount, images: images, sectionPlaylist: sectionPlaylist)
        return section
    }//internal function addFeaturedSection
    ...
    internal func addSlide() -> Section
    {
        ...
        let section = Section(sectionType: sectionType, sectionTitle: sectionTitle, searchID: searchID, videoList: videoList, buttons: buttons, displayCount: nil, images: images, sectionPlaylist: nil)
        for slide in slides {section.addSlide(slide: slide)}
        return section
    }
    internal func getOrder() -> [CategoryOrder] {return settings.categoryOrder!}
}
...
class Category
{
    ...
    func createUpcomingSection() {sections.append(categoryFactory.addUpcomingSection())}
    func createFeaturedSection() {sections.append(categoryFactory.addFeaturedSection())}
    func createFeatured2Section() {sections.append(categoryFactory.addFeatured2Section())}
    func createFeatured3Section() {sections.append(categoryFactory.addFeatured3Section())}
    func createSlider() {slider = (categoryFactory.addSlide())}
    func createRecentSection() {sections.append(categoryFactory.addRecentSection())}
    func createRecent2Section() {sections.append(categoryFactory.addRecent2Section())}
    func createRecentBoysSection() {sections.append(categoryFactory.addRecentBoysSection())}
    func createRecentGirlsSection() {sections.append(categoryFactory.addRecentGirlsSection())}
    func createPopularSection() {sections.append(categoryFactory.addPopularSection())}
    func createSpecificSection() {}
    func createSpecificSearchSection() {}
    func createButtonSection() {sections.append(categoryFactory.addButtons())}
    func createSquareSection() {sections.append(categoryFactory.addSquareButtons())}
    func createButtonSectionSecond() {sections.append(categoryFactory.addButtonsSecond())}
    func createButtonSectionThird() {sections.append(categoryFactory.addButtonsThird())}
    func getSection(row: Int) -> Section {return sections[row]}
}//class Category
...
class Section
{
    ...
    init(sectionType: SectionType, sectionTitle: String?, searchID: Int?, videoList: [Int]?, buttons: [Button]?, displayCount: Int?, images: [UIImage]?, sectionPlaylist: String?)
    {
        ...
        if(buttons != nil) {self.buttons = buttons!}
        if(images != nil) {self.images = images!}
    }//init
    
    func addSlide(slide: Slide) {slides.append(slide)}
    func getCategoryImage() -> UIImage {return images.first!!}
    func getDisplayCount() -> Int? {return displayCount}
    func getSlide(position: Int) -> Slide?
    {
        if(slides.count >= position - 1) {return slides[position - 1]}
        return nil
    }//getSlide
}//Section
...
class ButtonFactory
{
    ...
    func getType() -> ButtonType? {return type}
    func getVideoID() -> Int? {return videoID}
    func getImage() -> UIImage? {return image}
    func getTitle() -> String? {return title}
    func getImageOverlay() -> String? {return imageOverlay}
    func getPage() -> String? {return page}
    func getCategory() -> Category? {return category}
    func getWebURL() -> URL? {return webURL}
}//class ButtonFactory
